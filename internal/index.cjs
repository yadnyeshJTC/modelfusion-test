...
__export(internal_exports, {
  ...
  callWithRetryAndThrottle: () => callWithRetryAndThrottle,
  createAudioMpegResponseHandler: () => createAudioMpegResponseHandler,
  createJsonErrorResponseHandler: () => createJsonErrorResponseHandler,
  createJsonResponseHandler: () => createJsonResponseHandler,
  createTextErrorResponseHandler: () => createTextErrorResponseHandler,
  createTextResponseHandler: () => createTextResponseHandler,
  executeFunctionCall: () => executeFunctionCall,
  loadApiKey: () => loadApiKey,
  parseEventSourceStream: () => parseEventSourceStream,
...
async function executeFunctionCall({
  ...
  const startMetadata = {
    functionType,
    callId: `call-${(0, import_nanoid.nanoid)()}`,
